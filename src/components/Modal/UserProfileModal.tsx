...
const UserprofileModal: React.FC<ModalProps> = ({
  ...
  return (
    <Dialog open={modalOpen} onOpenChange={setModalOpen} >
      ...
      <section className="flex min-w-[60vw] h-full md:h-[75%] flex-col md:flex-row bg-[#EEEEEE] p-0 gap-0 border border-black rounded absolute right-[19px] top-[79px] z-50 overflow-auto md:overflow-hidden scrollbar-hidden"

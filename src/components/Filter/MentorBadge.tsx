...
const  MentorBadge: React.FC<SizeProps> = ({ width, stroke, yOffset = 30 }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox={`0 3 30 ${yOffset}`} fill="none" className={`inline ${width}`}>

...
const NetworkingBadge: React.FC<SizeProps> = ({ width, stroke, height }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 1 26 26" fill="none" className={`inline ${width} ${height} -mt-1`}>

...
const GoalBuddyBadge: React.FC<SizeProps> = ({ width, height }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none" className={`inline ${width} ${height} -mt-1`}>
